...
const PRIMARY: { key: GroupKey; items: NavItem[] }[] = [
  {
    ...
    items: [
      ...
      { href: "/dashboard/alert-rules", labelKey: "alertRules", icon: ListChecks, permission: "alert.read" },
      { href: "/dashboard/maintenance", labelKey: "maintenance", icon: CalendarClock, permission: "alert.read" },
