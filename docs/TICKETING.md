...
Full operator runbook: [CMDB.md](CMDB.md).
...
`POST https://novacrm.click/api/v1/t/{slug}/webhooks/cmdb` — same Alert secret. Test connection must show **CMDB sync ready**. The inbound webhook URL is not used for CMDB.
